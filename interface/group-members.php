<div id="add-group-members" class="buse-widget">
	<div class="buse-widget-header">
		<h4 id="add-group-members-header"><?php _e( 'Add User to this Group', 'bu-section-editing' ); ?></h4>
	</div>
	<div class="buse-widget-body">
		<div id="members-message" ></div>
		<div class="form-field">
			<label for="user_login"><?php _e( 'Enter the email address of an existing user on this network to add them to this Editor Group.', 'bu-section-editing' ); ?></label>
			...
			<button id="add_member" class="button-secondary"><?php _e( 'Add', 'bu-section-editing' ); ?></button>
		</div>
	</div>
</div>
...
<div id="group-members" class="buse-widget">
	<div class="buse-widget-header">
		<div id="member-list-count">
			<span class="member-count"><?php echo count( $group->users ); ?></span> <span class="member-count-label"><?php echo _n( 'member', 'members', count( $group->users ), 'bu-section-editing' ); ?></span>
		</div>
		<h4 id="edit-group-members-header"><?php _e( 'Group Member List', 'bu-section-editing' ); ?></h4>
	</div>
	<div class="buse-widget-body">
		<ul id="group-member-list">
			...
			<li class="member<?php if ( $group->has_user( $user->ID ) ) :  ?> active<?php endif; ?>" >
				<a id="remove_member_<?php echo $user->ID; ?>" class="remove_member" href="#"><?php _e( 'Remove', 'bu-section-editing' ); ?></a>
